...
namespace Com.Gosol.INOUT.API.Controllers.QuanTriHeThong
{
    ...
    [Route("api/v1/VaoRa")]
    [ApiController]
    public class IdicController : BaseApiController
    {
        private IVaoRaBUS _VaoRaBUS;
        private ISystemConfigBUS _SystemConfigBUS;
        public IOptions<AppSettings> settings;
        public IdicController(IOptions<AppSettings> Settings,IVaoRaBUS VaoRaBUS, ISystemConfigBUS SystemConfigBUS, ILogHelper _LogHelper, ILogger<IdicController> logger) : base(_LogHelper, logger)
        {
